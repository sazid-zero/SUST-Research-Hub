...
\restrict sRxXQyoFlc0Se9O4bgHrjq0CF2l2qwj3TcKOODtPgXTQWJQ6reT0lRkMqtt7JMn
...
CREATE TABLE public.publication_files (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT publication_files_resource_type_check CHECK (((resource_type)::text = ANY ((ARRAY['code'::character varying, 'dataset'::character varying, 'model'::character varying, 'supplementary'::character varying, 'other'::character varying])::text[])))
);
...
CREATE TABLE public.publications (
    ...
    CONSTRAINT publications_publication_type_check CHECK (((publication_type)::text = ANY ((ARRAY['journal'::character varying, 'conference'::character varying, 'workshop'::character varying, 'preprint'::character varying, 'book_chapter'::character varying, 'other'::character varying])::text[]))),
...
\unrestrict sRxXQyoFlc0Se9O4bgHrjq0CF2l2qwj3TcKOODtPgXTQWJQ6reT0lRkMqtt7JMn
