...
export default function ModelsContent({ user }: ModelsContentProps) {
    ...
    const [activeTab, setActiveTab] = useState<"main" | "tasks" | "libraries" | "domains">("main") // Updated activeTab state
    const [parameterRange, setParameterRange] = useState([0, 500]) // in billions
