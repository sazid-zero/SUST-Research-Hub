...
export function BrowseContent({ user, theses }: BrowseContentProps) {
  ...
  useEffect(() => {
    ...
    if (savedState) {
      try {
        ...
        setSelectedYear(state.selectedYear || "All Years")
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="border-b border-border bg-gradient-to-br from-background via-background to-muted py-6 md:py-8 px-4 md:px-0 mt-[120px] md:mt-0">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-2 md:mb-4">
            Browse Thesis Repository
          </h1>
