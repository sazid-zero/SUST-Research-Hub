...
export default function CreateWorkspacePage() {
  const [workspaceType, setWorkspaceType] = useState("publication")
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="border-b border-border bg-card">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/supervisor/dashboard" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-2 text-sm">
          ...
          <form action={formAction}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Start a new scholarly publication workspace.
                </CardDescription>
              </CardHeader>
              ...
              <CardFooter className="flex justify-end gap-3">
                <Button variant="outline" asChild type="button">
                  <Link href="/supervisor/dashboard">Cancel</Link>
                </Button>
